...
<head> 
    ...
    <link rel="icon" type="image/jpg" href="{{ asset('assets/images/halalin-icon.png') }}">
</head>
<body>
...
<div id="login">
    <div class="login-container">
        <div class="wrapper">
            <img src="{{ asset('assets/images/halalin-logo.png') }}" />
            ...
            <div class="field">
                ...
                <p class="hasil">
                    Belum punya akun?
                    <a href="{{ route('ustadz.register') }}" style="text-decoration: none; color: inherit">
