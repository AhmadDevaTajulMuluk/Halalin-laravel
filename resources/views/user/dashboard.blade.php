...
<head>
    ...
    <style>
        .rating {
            color: orange;
            /* Warna default untuk bintang yang tidak dipilih */
...
<body>
    @if (session('errorTaaruf'))
        <div id="error-alert"
            style="display: flex; width: 100%; justify-content: center; transition: 5s ease; z-index: 9999; position: fixed; top: 20;">
