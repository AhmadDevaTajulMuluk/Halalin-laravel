...
class BiodataController extends Controller
{
    ...
    public function storeProfile(Request $request)
    {
        $request->validate([
            ...
            'birth_date' => 'required|date|before_or_equal:2007-01-01',
            ...
            'birth_date.before_or_equal' => 'Minimal usia harus 17 tahun',
    ...
    public function updateProfile(Request $request)
    {
        ...
        $request->validate([
            ...
            'phone_number' => 'required|string|max:15',
            'place_date' => 'required|string|max:30',
            'birth_date' => 'required|date|before_or_equal:2007-12-31',
            'gender' => 'required|string|max:15',
            'job' => 'required|string|max:30',
            'salary' => 'required|numeric',
            'married_status' => 'required|string|max:30',
